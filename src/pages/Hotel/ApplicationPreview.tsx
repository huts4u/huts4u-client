...
//                   </Box>
//                 ) : (
//                   <Typography sx={commonStyles.value}>{value as string}</Typography>
//                 )}
//               </Grid>
//             )
//         )}
...
//                       ? roomValue.length > 0
//                         ? (roomValue.join(", ") as React.ReactNode)
//                         : "N/A"
//                       : (roomValue as React.ReactNode) || "N/A"}
...
const ApplicationPreview = () => {
  ...
  useEffect(() => {
    getMyAllHotelswithBelongsTo({
      ...
      .then((res) => {
        // Remove excluded fields from hotel data
        ...
        // Remove excluded fields from room data
        const filteredRoomData = Array.isArray(filteredHotelData?.rooms)
          ? filteredHotelData.rooms.map((room: any) =>
            Object.fromEntries(
  ...
  const handleConfirmAction = () => {
    console.log(actionType === "approve" ? "Application Approved" : "Application Rejected");
    setOpenDialog(false);
  };
